...
public class BorrarRestauranteMDB implements MessageListener, ExceptionListener {
	
	public final static int TIME_OUT = 5;
	private final static String APP = "appJPFP";
	
	private final static String GLOBAL_TOPIC_NAME = "java:global/RMQTopicBorrarRestaurante";
	...
	public BorrarRestauranteMDB(TopicConnectionFactory factory, InitialContext ctx) throws JMSException, NamingException 
	{	
	...
	public String borrarRemoteRestaurante(String nomR) throws JsonGenerationException, JsonMappingException, JMSException, IOException, NonReplyException, InterruptedException, NoSuchAlgorithmException
	{
		answer=null;
		...
		try 
		{
			...
			if(!ex.getSender().equals(APP))
			{
				if(ex.getStatus().equals(REQUEST))
				{
					...
					String payload = "Se ha borrado el restaurante "+ex.getPayload()+" de la rotonda "+ex.getSender();
